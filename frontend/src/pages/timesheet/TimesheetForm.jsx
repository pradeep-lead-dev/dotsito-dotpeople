...
const TimesheetForm = () => {
    ...
    const fetchTimesheetData = async () => {
        try {
            ...
            const response = await axios.get('http://localhost:5000/get-timesheet', {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                'http://localhost:5000/save-timesheet',
                { workingHours },
                { headers: { Authorization: `Bearer ${parsedToken.userToken}` } }
            );
    ...
    const fetchApprovals = async () => {
        try {
            ...
            const parsedToken = JSON.parse(token);
            const response = await axios.get('http://localhost:5000/get-approvals', {
                headers: { Authorization: `Bearer ${parsedToken.userToken}` },
            });
